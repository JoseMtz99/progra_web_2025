...
<body>
        ...
        <div>
            <div id="carouselExampleIndicators" class="carousel slide">
                <div class="carousel-indicators">
                    <h1 class="roboto-slab-titulo">Red de investigación del TecNM</h1>
    ...
    <nav class="navbar navbar-expand-lg nav_bar">
        <img src="images/general/logotipo.jpeg" class="img-fluid" alt="..." width="5%" height="5%">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="miembros.php">Investigadores</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="contacto.php">Contacto</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="colabora.php">Colabora con nosotros</a>
                    </li>
                    <li class="nav-item">
